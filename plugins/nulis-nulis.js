...
let handler = async (m, { conn, args }) => {
    ...
    let d = new Date()
    let tgl = d.toLocaleDateString('id-Id', { timeZone: 'Africa/Harare' })
    let hari = d.toLocaleDateString('id-Id', { weekday: 'long', timeZone: 'Africa/Harare' })
    let teks = args.join` `
